...
compileEnv _env (Tuple _es _)       = error "TBD:compileEnv:tuple"

compileEnv _env (GetItem _vE _vI _) = error "TBD:compileEnv:getItem"

compileEnv _env (Lam _xs _e  _l)    = error "TBD:compileEnv:Lam"
compileEnv _env (Fun _f  _xs _e _l) = error "TBD:compileEnv:Fun"
compileEnv _env (App _v  _vs _l)    = error "TBD:compileEnv:App"
